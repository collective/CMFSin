...
from Products.CMFSin.config import PROJECTNAME
...
class CMFSinTestCase(PloneTestCase):
    """Base class for integration tests for the 'CMFSin' product. This may
    provide specific set-up and tear-down operations, or provide convenience
    methods.
    """

class CMFSinFunctionalTestCase(FunctionalTestCase):
    """Base class for functional integration tests for the 'CMFSin' product. 
